defmodule CardDesc do
  ...
  def render(assigns) do
    ...
    <div :hook="CardDescHook" id="card_desc_container"
      ...
      <div id="md-editor" class="pl-4">{@card_desc_info}</div>
      <template x-if="is_show_button">
        <div class="flex flex-row items-center ml-4">
          <button x-on:click="CardDescHook.saveContent" class="w-20 h-8 mt-2 bg-[rgb(0,121,191)] hover:bg-[rgb(2,106,167)] rounded text-white">保存</button>
